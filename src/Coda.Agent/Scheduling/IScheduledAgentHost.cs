...
/// final text. Implemented by the concrete scheduled-agent host (<c>ScheduledAgentHost</c>); the
/// task manager owns registration/lifecycle and calls this to execute the scheduled work, wiring
/// the root's task id, depth, steering inbox, and output sink through to the child
