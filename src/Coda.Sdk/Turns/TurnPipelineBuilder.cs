...
public sealed class TurnPipelineBuilder
{
    ...
    /// </param>
    /// <param name="subagentSettings">
    /// The session's subagent limits and system-prompt policy, handed to every subagent host this
    /// builder creates. Null uses the defaults.
    /// </param>
