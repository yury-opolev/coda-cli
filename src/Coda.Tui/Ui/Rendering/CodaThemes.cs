...
internal static class CodaThemes
{
    public static CodaTheme Default { get; } = new(
        ...
        new TuiTheme
        {
            ...
            ComposerPanelBackground = new(new TgColor(32, 34, 44), TgName.Black),
            ComposerPanelEdge = new(new TgColor(32, 34, 44), TgName.Black),
    ...
    public static CodaTheme CoolDark { get; } = new(
        ...
        new TuiTheme
        {
            ...
            ComposerPanelBackground = new(new TgColor(28, 34, 46), TgName.Black),
            ComposerPanelEdge = new(new TgColor(28, 34, 46), TgName.Black),
