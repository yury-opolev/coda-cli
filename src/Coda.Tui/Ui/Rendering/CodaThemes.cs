...
internal static class CodaThemes
{
    public static CodaTheme Default { get; } = new(
        ...
        new TuiTheme
        {
            ...
            PermissionApproval = new(new TgColor(220, 80, 80), TgName.BrightRed),
            Question = new(new TgColor(220, 170, 60), TgName.BrightYellow),
            Warning = new(new TgColor(200, 150, 40), TgName.Yellow),
            Notification = new(new TgColor(160, 170, 185), TgName.Gray),
            Error = new(new TgColor(200, 70, 70), TgName.Red),
            ToolSuccess = new(new TgColor(70, 195, 85), TgName.BrightGreen),
            ToolPartialFailure = new(new TgColor(215, 155, 40), TgName.Yellow),
            PermissionApproved = new(new TgColor(230, 170, 65), TgName.BrightYellow),
            ...
            ComposerPanelEdge = new(new TgColor(40, 45, 55), TgName.Black),
    ...
    public static CodaTheme CoolDark { get; } = new(
        ...
        new TuiTheme
        {
            ...
            PermissionApproval = new(new TgColor(240, 80, 80), TgName.BrightRed),
            Question = new(new TgColor(220, 160, 40), TgName.BrightYellow),
            Warning = new(new TgColor(200, 140, 30), TgName.Yellow),
            Notification = new(new TgColor(150, 170, 190), TgName.Gray),
            Error = new(new TgColor(210, 70, 70), TgName.Red),
            ToolSuccess = new(new TgColor(55, 205, 100), TgName.BrightGreen),
            ToolPartialFailure = new(new TgColor(210, 145, 35), TgName.Yellow),
            PermissionApproved = new(new TgColor(220, 160, 55), TgName.BrightYellow),
            ...
            ComposerPanelEdge = new(new TgColor(30, 40, 55), TgName.Black),
