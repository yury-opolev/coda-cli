...
public static class ImmediateCli
{
    ...
    private static void WriteUsage(TextWriter writer)
    {
        ...
        writer.WriteLine("  Up / Down       Move the caret between lines of a multi-line prompt, then step");
        writer.WriteLine("                  through prompt history once the caret reaches the first/last line.");
        ...
        writer.WriteLine("  Ctrl+C          Copy the current selection; with no selection, press twice to exit.");
        writer.WriteLine("  Drag / Shift    Select transcript or composer text by dragging with the mouse, or");
        writer.WriteLine("                  by holding Shift with the arrows/Home/End.");
